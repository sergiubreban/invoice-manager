...
const InvoiceForm = () => {
  ...
  return <form onSubmit={handleSubmit((data: any) => submitForm(data))} data-testid="form">
    <Wrap spacing={2}>
      <WrapItem>
        <FormControl>
          <FormLabel htmlFor="myCompany">{'MyCompany'}</FormLabel>
          <AutoComplete onChange={(val) => {
      ...
      <Wrap>
        <WrapItem>
          <FormControl>
            ...
            <Box color='#000'><ReactDatePicker selected={issueDate} onChange={(date) => setIssueDate(date)} /></Box>
          </FormControl>
        </WrapItem>
        <WrapItem>
          <FormControl>
            <FormLabel>{'Due Date'}</FormLabel>
            <Box color='#000'><ReactDatePicker selected={dueDate} onChange={(date) => setDueDate(date)} /></Box>
          </FormControl>
        </WrapItem>
      </Wrap>
      <Wrap>
